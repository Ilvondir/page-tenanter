...
<template>
    ...
    <div class="overflow-x-hidden antialiased">
        ...
        <header class="relative z-40 w-full h-24">
            <div
                class="container flex items-center justify-center h-full max-w-6xl px-8 mx-auto sm:justify-between xl:px-0">

                <Link href="/" class="relative flex items-center inline-block h-5 h-full font-black leading-none">

                    <ApplicationMark class="w-12"/>

                    <span class="ml-3 text-xl text-gray-800">PageTenanter<span class="text-sky-600">.</span></span>
                </Link>

                <nav id="nav"
                     class="absolute top-0 left-0 z-40 flex flex-col items-center justify-between hidden w-full h-64 pt-5 mt-24 text-sm
                     text-gray-800 bg-white border-t border-gray-200 md:w-auto md:flex-row md:h-24 lg:text-base md:bg-transparent md:mt-0
                     md:border-none md:py-0 md:flex md:relative">
                    <NavLink href="#"
                             class="ml-0 mr-0 font-bold duration-100 md:ml-12 md:mr-3 lg:mr-8 transition-color hover:text-sky-600">
                        {{ __('homepage.Home') }}
                    </NavLink>
                    <NavLink href="#features"
                             class="mr-0 font-bold duration-100 md:mr-3 lg:mr-8 transition-color hover:text-sky-600">
                    ...
                    <NavLink href="#testimonials"
                             class="font-bold duration-100 transition-color hover:text-sky-600">
                        {{ __('homepage.Opinions') }}
                    </NavLink>
                    <div class="duration-100 transition-color hover:text-sky-600 md:hidden">
                        <LanguageDropdown/>
                    </div>
                ...
                <div
                    class="absolute left-0 flex-col items-center justify-center hidden w-full pb-8 mt-48 border-b border-gray-200 md:relative md:w-auto
                    md:bg-transparent md:border-none md:mt-0 md:flex-row md:p-0 md:items-end md:flex md:justify-between">
                ...
                <div id="nav-mobile-btn"
                     class="absolute top-0 right-0 z-30 block w-6 mt-8 mr-10 cursor-pointer select-none md:hidden sm:mt-10">
        ...
        <!-- BEGIN HERO SECTION -->
        <div
            class="relative items-center justify-center w-full overflow-x-hidden lg:pt-40 lg:pb-40 xl:pt-40 xl:pb-64 pt-32">

            <div
                class="container flex flex-col items-center justify-between h-full max-w-6xl px-8 mx-auto -mt-32 lg:flex-row xl:px-0">
                <div
                    class="z-30 flex flex-col items-center w-full max-w-xl pt-12 text-center lg:items-start lg:w-1/2 lg:pt-6 xl:pt-12 lg:text-left">
                    <h1 class="relative mb-4 text-3xl font-black leading-tight text-gray-900 sm:text-6xl xl:mb-8">
                        {{ __('homepage.Build the Next Great Thing') }}
                    </h1>
                    <p class="pr-0 mb-8 text-base text-gray-600 sm:text-lg xl:text-xl lg:pr-20">
                        {{
                            __('homepage.Are you ready to start your adventure and start building the next great webpage?')
                        }}
                    </p>
                    <a href="#_"
                       class="relative self-start inline-block w-auto px-8 py-4 mx-auto mt-0 text-base font-bold text-white bg-sky-600 border-t border-gray-200 rounded-md shadow-xl sm:mt-1 fold-bold lg:mx-0">
                        {{ __('homepage.Signup Today!') }}
                    </a>
                            ...
                            <g id="Desktop-HD" transform="translate(-39 -531)">
                                <g id="Hero" transform="translate(43 83)">
                                    <g id="Rectangle-6" transform="rotate(45 213 654)">
                                        <use fill="#00a6f4" xlink:href="#path-2"/>
                                    </g>
                                </g>
                            </g>
                        </g>
                ...
                <img :src="url + '/img/webpage.png'" alt="Webpage." class="lg:w-[500px] xl:w-[650px] pl-10 z-30">
            </div>
        </div>
        <!-- HERO SECTION END -->

        <svg class="absolute top-60 hidden w-screen max-w-3xl -mt-64 -ml-12 lg:block z-20" style="right: -350px"
             viewBox="0 0 818 815" xmlns="http://www.w3.org/2000/svg"
             xmlns:xlink="http://www.w3.org/1999/xlink">
            <defs>
                <linearGradient x1="0%" y1="0%" x2="100%" y2="100%" id="c">
                    <stop stop-color="#E614F2" offset="0%"/>
                    <stop stop-color="#8604F2" offset="100%"/>
                </linearGradient>
                <linearGradient x1="0%" y1="0%" x2="100%" y2="100%" id="f">
                    <stop stop-color="#00a6f4" offset="0%"/>
                    <stop stop-color="#0056a4" offset="100%"/>
                </linearGradient>
        ...
        <div class="relative px-8 py-10 bg-white border-t border-gray-200 md:py-16 lg:py-24 xl:py-40 xl:px-0">
            ...
            <div id="pricing" class="container flex flex-col items-center h-full max-w-6xl mx-auto">
                ...
                <h3
                    ...
                    {{ __('homepage.Simple, Transparent Pricing for Everyone') }}
                </h3>
                ...
                <div class="max-w-full mx-auto md:max-w-6xl sm:px-8">
                    ...
                    <div class="relative flex flex-col items-center block sm:flex-row">
                        <div
                            class="relative z-0 w-11/12 max-w-sm my-8 border border-gray-200 rounded-lg sm:w-1/2 lg:w-1/2 sm:my-5 md:-mr-4">
                            <div
                                ...
                                <div
                                    ...
                                    <h3 class="p-3 text-lg font-bold tracking-wide text-center uppercase">
                                        {{ __('homepage.Basic Plan') }}
                                    </h3>
                                    <h4
                                    ...
                                    <p class="text-sm text-gray-600">
                                        {{
                                            __('homepage.In our basic plan you can take advantage of all these features below')
                                        }}
                                    </p>
                                </div>
                        ...
                        <!-- Pro Pricing -->
                        <div
                            class="relative z-10 w-full max-w-md my-8 bg-white rounded-lg shadow-lg sm:w-3/5 lg:w-3/5 sm:my-5">
                            <div
                                class="py-4 text-sm font-semibold leading-none tracking-wide text-center text-white uppercase bg-sky-500 rounded-t">
                                {{ __('homepage.Most Popular') }}
                            </div>
                            <div
                                class="block max-w-sm px-8 mx-auto mt-5 text-sm text-left text-black sm:text-md lg:px-6">
                                <h3 class="p-3 pb-1 text-lg font-bold tracking-wide text-center uppercase">
                                    {{ __('homepage.Pro Plan') }}
                                </h3>
                                <h4
                                ...
                                <p class="text-sm text-gray-600">
                                    {{
                                        __('homepage.Our most popular package is the Pro Plan which gives you access to the following:')
                                    }}
                                </p>
                            </div>
                            ...
                            <blockquote
                                ...
                                <div class="flex flex-col pr-10">
                                    <div class="relative pl-12">
                                        ...
                                        <p class="mt-2 text-base text-gray-600">Extremely helpful in every single
                                            project we
                                            have released.
                                        </p>
                                    </div>
                                    ...
                                    <h3 class="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">Mike
                                        Smith
                                        <span
                                            class="mt-1 text-sm leading-5 text-gray-500 truncate">- CEO SomeCompany</span>
                                    </h3>
                                    <p class="mt-1 text-sm leading-5 text-gray-500 truncate"></p>
                                </div>
                                <img class="flex-shrink-0 object-cover w-24 h-24 mb-5 bg-gray-300 rounded-full md:mb-0"
                            ...
                            <blockquote
                                ...
                                <div class="flex flex-col pr-10">
                                    <div class="relative pl-12">
                                        ...
                                        <p class="mt-2 text-base text-gray-600">Finally a quick and easy system I can
                                            use
                                            for any type of
                                            project.</p>
                                    </div>
        ...
        <footer class="px-4 pt-12 pb-8 text-white bg-white border-t border-gray-200">
            <div class="container flex flex-col justify-between max-w-6xl px-4 mx-auto overflow-hidden lg:flex-row">
                <div class="w-full pl-12 mr-4 text-left lg:w-1/4 sm:text-center sm:pl-0 lg:text-left">
                    ...
                    <p class="mt-6 mr-4 text-base text-gray-500">
                        {{ __('homepage.Crafting the next level of user experience and user interfaces') }}.
                    </p>
                </div>
            ...
            <div class="pt-4 pt-6 mt-10 text-center text-gray-500 border-t border-gray-100">© 2025 PageTenanter.
                {{ __('homepage.All rights reserved') }}.
            </div>

            <div class="pt-2 pt-4 mt-2 text-center text-gray-600 border-t border-gray-100">
                {{ __('homepage.Distributed by') }} <a
                href="https://github.com/Ilvondir/">Ilvondir</a></div>
        </footer>
