    ...
    <div class="overflow-x-hidden antialiased">
        ...
        <header class="relative z-50 w-full h-24">
            <div
                ...
                <nav id="nav"
                     class="absolute top-0 left-0 z-50 flex flex-col items-center justify-between hidden w-full h-64 pt-5 mt-24 text-sm
                    ...
                    <div class="flex flex-col block w-full font-medium border-t border-gray-200 md:hidden">
                        ...
                        <Link href="#_"
                              class="relative inline-block w-full px-5 py-3 text-sm leading-none text-center text-white bg-sky-600 fold-bold">
                            {{ __('homepage.Get started') }}
                        </Link>
                    </div>
                </nav>
                ...
                <div
                    ...
                    <Link href="#_"
                          class="relative z-40 inline-block w-auto h-full px-5 py-3 text-sm font-bold leading-none text-white transition-all transition duration-100 duration-300 bg-sky-700 rounded shadow-md fold-bold lg:bg-white lg:text-sky-700 sm:w-full lg:shadow-none hover:shadow-xl">
                        {{ __('homepage.Get started') }}
                    </Link>
        ...
        <div class="relative items-center justify-center w-full overflow-x-hidden lg:pt-40 lg:pb-40 xl:pt-40 xl:pb-64">
            <div
                ...
                <img :src="url + '/img/webpage.png'" alt="Webpage." class="z-50 lg:w-[500px] xl:w-[650px] pl-10">
            </div>
        </div>
        <!-- HERO SECTION END -->
