    ...
    <div class="overflow-x-hidden antialiased">
        ...
        <div class="relative px-8 py-10 bg-white border-t border-gray-200 md:py-16 lg:py-24 xl:py-40 xl:px-0">
            ...
            <div id="pricing" class="container flex flex-col items-center h-full max-w-6xl mx-auto">
                <h2 class="my-5 text-base font-medium tracking-tight text-sky-500 uppercase">Our Pricing</h2>
                <h3
                    ...
                    <div class="relative flex flex-col items-center block sm:flex-row">
                        <div
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <p class="text-sm text-gray-600">In our basic plan you can take advantage of all
                                        these
                                        features below.
                                    </p>
                                </div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p class="text-sm text-gray-600">Our most popular package is the Pro Plan which gives
                                    you
                                    access to the
                                    following:</p>
                            </div>
                            ...
                            <div class="flex items-center block p-8 uppercase">
                                <a href="#_"
                                   class="block w-full px-6 py-4 mt-3 text-lg font-semibold text-center text-white bg-gray-900 rounded shadow-sm hover:bg-sky-600">Select
                                    This Plan</a>
                            </div>
                        </div>
                        <!-- Premium Pricing -->
                        <div
                            ...
                            <div class="overflow-hidden text-black bg-white rounded-lg shadow-lg shadow-inner">
                                <div
                                    ...
                                    <p class="pl-2 text-sm text-gray-600">With our premium plan you can take advantage
                                        of
                                        all the following
                                        features:</p>
                                </div>
